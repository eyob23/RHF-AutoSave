...
export { AutosaveMutationLog, AutosaveStateSummary } from "./components/autosaveHelpers";
...
export { applyPaths, cloneDeep, deepMerge, diffArraysBy, findChangedPaths, isDeepEqual } from "./utils/deep";
export {
	deleteByPath,
	flattenObject,
	getAllPaths,
